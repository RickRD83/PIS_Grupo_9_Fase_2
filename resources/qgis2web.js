...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 27, minZoom: 2, projection: new ol.proj.Projection({
            code: 'EPSG:32717',
            //extent: [613885.901837, 9640675.135008, 614441.712824, 9641163.859245],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([613885.901837, 9640675.135008, 614441.712824, 9641163.859245], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa interactivo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (101 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Estudio de Riesgo Hidrico Urbano en el sector  Sector Av. 25 de Junio y Circunvalación Norte, Machala';
            }
